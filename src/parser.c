...
enum {
  ...
  field_markup_element = 5,
  field_markup_element_content = 6,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [85] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_node, 1, .production_id = 1),
  [87] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_node, 1, .production_id = 1),
  ...
  [93] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_node, 1, .production_id = 2),
  [95] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_node, 1, .production_id = 2),
